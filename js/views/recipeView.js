  ...
  ></div>
    ...
    <div class="flex flex-row items-center justify-around h-[30%]">
     ...
     <div class="flex flex-col md:flex-row space-y-2 items-center md:space-y-0 md:space-x-2 p-1">
        ...
        <div class="flex space-x-2">
              <button class="btn-update-servings btn-tiny" data-update-to="${
                this._data.servings - 1
              }">
                <svg
                  class=" h-5 w-5 md:h-6 md:w-6  fill-green-700">
              ...
              <button class="btn-update-servings btn-tiny" data-update-to="${
                ...
                <svg class=" h-5 w-5 md:h-6 md:w-6  fill-green-700">
       ...
       <div class="flex items-center space-x-2 p-1">
          ...
          <button class="${this._data.key? "" : "hidden"}">
            <svg class="recipe__info-icon h-5 w-5 md:h-6 md:w-6 fill-green-700">
              <use href="${icons}#icon-user"></use>
            </svg>
          </button>
                
          <button class="bg-green-500 p-2 rounded-full btn-bookmark">
            <svg
              class=" h-5 w-5 stroke-white ${
                this._data.bookmarked ? "fill-white" : "fill-green-500"
              } md:h-6 md:w-6  "
            >
